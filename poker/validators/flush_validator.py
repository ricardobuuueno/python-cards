class FlushValidator():
    ...
    def is_valid(self):
        return len(self._suit_that_occurs_5_or_more_times) == 1

    def valid_cards(self):
        cards = [card for card in self.cards if card.suit in self._suit_that_occurs_5_or_more_times.keys()]
        return cards[-5:]

    @property
    def _suit_that_occurs_5_or_more_times(self):
        return {
            suit: suit_count
